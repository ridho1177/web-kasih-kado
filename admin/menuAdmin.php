            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <button class="btn btn-success" type="submit">Tambah Admin</button>
                        </form>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="mytable" width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            $data_barang = mysqli_query($con, "SELECT * FROM admin ORDER BY id_admin DESC LIMIT $halaman_awal, $batas");
                                            $nomor = $halaman_awal+1;
                                            while ($record = mysqli_fetch_array($data_barang)) {
                                        ?>
                                                <tr>
                                                    <td><?php echo $record['nama_admin'] ?></td>
                                                    <td><?php echo $record['username'] ?></td>
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="hapusadmin.php?idadmin=<?php echo $record['id_admin'] ?>;" class="btn btn-sm btn-danger delete"
                                                                >Delete</a>
                                                        </div>
