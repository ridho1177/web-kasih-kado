...
<section class="mb-5">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
	  ...
	  <br><br>
	  <div> 
	  <button type="button" class="btn btn-light btn-md mr-1 mb-2t"><a href="checkout.php?idbarang=<?php echo $review['id_barang']?>">Beli Sekarang</a></button>
      <button type="button" class="btn btn-light btn-md mr-1 mb-2"><a href="add_cart.php?id=<?php echo $review['id_barang']; ?>"><span class="glyphicon glyphicon-plus"></span>Tambah Keranjang</a></button>
		  </div>
    </div>
  </div>
